...
export function MathCanvas({ variant = "hero" }: MathCanvasProps) {
  ...
  useEffect(() => {
    ...
    const drawBackdrop = () => {
      ...
      gradient.addColorStop(0, "#0b3150");
      gradient.addColorStop(0.36, "#071a28");
    ...
    const drawAlgebraicCurve = (time: number, emphasis = 1) => {
      ...
      for (let family = 0; family < families; family += 1) {
        ...
        context.strokeStyle =
          family % 4 === 0
            ? `rgba(211, 180, 108, ${alpha + 0.08})`
            : isDark
              ? `rgba(70, 224, 211, ${alpha})`
    ...
    const drawContours = (time: number) => {
      ...
      for (let ring = 1; ring <= rings; ring += 1) {
        ...
        context.strokeStyle = isDark
          ? `rgba(57, 219, 204, ${0.06 + ring * 0.009})`
          : ring % 4 === 0
            ? "rgba(201, 168, 91, 0.22)"
            : "rgba(10, 95, 180, 0.11)";
    ...
    const drawCursorSingularity = (time: number) => {
      ...
      for (let ring = 0; ring < 4; ring += 1) {
        ...
        context.strokeStyle = isDark
          ? `rgba(70, 224, 211, ${0.25 - ring * 0.045})`
